...
\begin{proof} 
Let $x_1,\dots,x_n\in A$. Assume that $A=k[x_1,\dots,x_n]$ and that the $x_i$ are algebraically dependent over $k$. In view of $(\star)$ above, it suffices to show that\medskip
...
$$
for some $a$ in $k^\times$ and some multi-index $\alpha$. Then \eqref{fyz2} gives an equation of integral dependence for $x_1$ over $k[\,y_2,\dots,y_n]$. 
\end{proof}
