...
$$ 
in $Aa^{-1}\otimes_AM$. This implies $ax=0$ because the map $M\to Aa^{-1}\otimes_AM$, $y\mapsto a^{-1}\otimes y$ is an isomorphism. %If $1\otimes x=0$ in $K\otimes M$, then $1\otimes x=0$ in $A\frac1a\otimes M$. This implies $ax=0$.
...
The notes in Section~\ref{satprel} p.~\pageref{satprel} above %Note~\ref{sat1} p.~\pageref{sat1} and Note~\ref{sat2} p.~\pageref{sat2} 
