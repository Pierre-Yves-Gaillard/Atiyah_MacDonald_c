...
(ZL) implies that $I(V)$ is the intersection of all the maximal ideals of $A:=k[t_1,\dots,t_n]$ containing $\mf a$. As $r(\mf a)$ is the intersection of all the prime ideals of $A$ containing $\mf a$, we can assume that $\mf a$ is a prime ideal $\mf p$. Let $f$ be in $A\setminus\mf p$. 
