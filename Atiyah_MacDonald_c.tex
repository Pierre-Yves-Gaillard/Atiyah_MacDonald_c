...
$$ 
by the second isomorphism theorem (Proposition 2.1.ii p.~19 of the book), and this quotient is simple. Symmetrically, $N_1/P_1\simeq M/M_1$. By the proof of Proposition 6.7 p.~77 of the book, $\ell(P_1)\le\ell(M_1)=n$ is finite, so $P_1$ has a composition series $P_1>P_2>\cdots>P_p=0$. Write $U$ for the quotient. Then $M_1>P_1>\cdots>P_p=0$ is a composition series for $M_1$. Since $\ell(M_1)=n$, we have $p=n$, and by the induction hypothesis, the multiset  
$$
...
Hint: see the proof of Hilbert Basis Theorem~\ref{hbt} p.~\pageref{hbt} above.
