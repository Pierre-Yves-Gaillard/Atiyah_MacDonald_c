...
$$ 
In particular, the equality $(\mf a^n)^\wedge=\hat A\,\mf a^n$ shows that the $\mf a$-topology and the $\hat{\mf a}$-topology of $\hat A$ coincide. The $\mf a$-topology is finer than the $\hat{\mf a}$-topology even if $A$ is not noetherian.
