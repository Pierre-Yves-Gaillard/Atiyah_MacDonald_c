...
Set $A_f:=A[1/f]$ and let $\mf p^{\oo e}$ be the extension of $\mf p$ in $A_f$. The extension $\mf p^{\oo e}$ of $\mf p$ in $A_f$ being clearly a proper ideal, there is a maximal ideal $\mf m\subset A_f$ containing $\mf p^{\oo e}$. 
