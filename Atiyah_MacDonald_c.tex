...
$$
B:=k\left[x_2-x_1^r,\dots,x_n-x_1^{r^{i-1}}\right].
$$ 
...
$$
g\in\bigg(k\left[X_2-X_1^r,\dots,X_n-X_1^{r^{i-1}}\right]\bigg)[X_1]
$$ 
...
$$
\bigg(k\left[X_2-X_1^r,\dots,X_n-X_1^{r^{i-1}}\right]\bigg)[X_1].
$$ 
Then $u'$ is monic. Moreover, if $u$ and $v$ are two such distinct monomials, then we have $\deg(u')\ne\deg(v')$.
