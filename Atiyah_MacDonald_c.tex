...
$$
%$$(B\otimes_AM)_\qqq\simeq\frac{B_\qqq}{\qqq_\qqq}\otimes_BB\otimes_AM\simeq\frac{B_\qqq}{\qqq_\qqq}\otimes_AM$$ $$=\frac{B_\qqq}{\ppp B_\qqq}\otimes_AM\simeq B_\qqq\otimes_{A_\ppp}\frac{A_\ppp}{\ppp_\ppp}\otimes_AM\simeq B_\qqq\otimes_{A_\ppp}M_\ppp\ .$$

\subsection{Page 46, Exercise 3.20}%\label{321iv}

Counterexample to the converse of (ii): $A:=K$ a field, $B:=K[\varepsilon]$ with $\varepsilon^2=0$, $f:K\to K[\varepsilon]$ the inclusion.%$B:=k$ a field, $A:=k[\varepsilon]$ with $\varepsilon^2=0$, $f:k[\varepsilon]\to k$ the canonical projection. 
