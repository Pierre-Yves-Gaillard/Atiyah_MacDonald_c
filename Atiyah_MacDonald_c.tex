...
\emph{Proof of the inequality} $\dim A[x]\ge1+\dim A$: If $\mf p_0,\dots,\mf p_n$ is a length $n$ ascending chain of prime ideals of $A$, then $\mf p_0[x],\dots,\mf p_n[x],(\mf p,x)$ is a length $n+1$ ascending chain of prime ideals of $A[x].\ \square$
...
Last sentence of the hint: now Exercise 11.6 implies 
$$
\oo{height}(\mf p)\le1+\oo{height}((\mf p)^{\oo c}[x])\le1+\dim A
$$ 
for all prime ideal $\mf p$ of $A[x]$, and thus $\dim A[x]\le1+\dim A$.
