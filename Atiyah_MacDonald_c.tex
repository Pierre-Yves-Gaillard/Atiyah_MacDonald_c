...
\section{Exercise 2.25 p.~34, second solution}
...
We fix a commutative ring $A$ with one. \emph{Module} shall mean $A$-\emph{module}. 
...
\end{tikzcd}
$$ 
with exact rows and columns. By the Snake Lemma (Lemma~\ref{sl2}) we get a ``bi-infinite'' exact sequence 
$$
...
\section{P. 54, Theorem 4.10}%\label{410}%
