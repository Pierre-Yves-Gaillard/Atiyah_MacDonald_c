...
Let $0\to C'\xr uC\xr vC''\to0$ be a short exact sequence of complexes. By applying the Snake Lemma (Theorem~\ref{lsl} p.~\pageref{lsl}) to 
$$
\begin{tikzcd}
...
\end{tikzcd}
$$ 
Using again the Snake Lemma (Theorem~\ref{lsl} p.~\pageref{lsl}), we get a ``bi-infinite'' exact sequence 
$$
